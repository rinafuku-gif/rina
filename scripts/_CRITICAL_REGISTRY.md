...
- `scripts/sync-notion-to-unified.js` — Notion Task DB→unified.db 同期 — ブリーフィングのタスク情報がNotion最新状態と同期されない
- `scripts/update-obsidian-tasks.js` — Obsidianタスク一覧・ダッシュボード自動更新 — ブリーフィング後のObsidian更新が停止
...
- `scripts/update-obsidian-dashboard.js` — Obsidianダッシュ週次更新 — 週次レビュー後のObsidian反映が停止
